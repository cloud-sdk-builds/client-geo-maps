...
[`@aws-sdk/client-geo-maps`](https://www.npmjs.com/package/@aws-sdk/client-geo-maps/v/3.1047.0).
...
- @aws-sdk/client-geo-maps v3.1047.0 - [https://cloud-sdk-builds.github.io/?sdk=client-geo-maps&version=3.1047.0](https://cloud-sdk-builds.github.io/?sdk=client-geo-maps&version=3.1047.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1047.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FULytoqu3LH9FqImQJ2XnBAXywndQfO9cSAd+p/8RWZRkB2lF9lmBQTF+n/dwX1F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-geo-maps": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1047.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1047.0/index.min.mjs": "sha384-FULytoqu3LH9FqImQJ2XnBAXywndQfO9cSAd+p/8RWZRkB2lF9lmBQTF+n/dwX1F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-geo-maps/blob/refs/tags/3.1047.0/LICENSE
```
