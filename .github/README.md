...
[`@aws-sdk/client-geo-maps`](https://www.npmjs.com/package/@aws-sdk/client-geo-maps/v/3.1049.0).
...
- @aws-sdk/client-geo-maps - [https://cloud-sdk-builds.github.io/?sdk=client-geo-maps](https://cloud-sdk-builds.github.io/?sdk=client-geo-maps)
- @aws-sdk/client-geo-maps v3.1049.0 - [https://cloud-sdk-builds.github.io/?sdk=client-geo-maps&version=3.1049.0](https://cloud-sdk-builds.github.io/?sdk=client-geo-maps&version=3.1049.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1049.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3nFYZhCa+oe+zE9MFylkJ3OQTiK0DGqTRpUQKY4zdUFBmWbSM2ZPdULLU74S0afk
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-geo-maps": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1049.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-geo-maps@3.1049.0/index.min.mjs": "sha384-3nFYZhCa+oe+zE9MFylkJ3OQTiK0DGqTRpUQKY4zdUFBmWbSM2ZPdULLU74S0afk"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-geo-maps";
...
```
https://github.com/cloud-sdk-builds/client-geo-maps/blob/refs/tags/3.1049.0/LICENSE
```
